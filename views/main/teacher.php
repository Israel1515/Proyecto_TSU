...
<div class="row">
    <div class="col-12">
        <?php
            ...
            if(empty($_POST)) { // condición anidada por si el método post esta vacio entonces	

                include_once '../register/teacher/table_teacher.php';

            }else{ //en el caso contrario

                include_once '../register/teacher/buscar_teacher.php';
            } 

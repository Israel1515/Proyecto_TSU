...
<div class="modal fade" id="ModaladdStudent"data-bs-backdrop="static" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">

      <div class="modal-header">
        <h3 class="modal-title text-center" id="viewModalLabel">Ingresar Datos del Estudiante</h3>
...
<br> <!-- etiqueta de salto de linea -->
          <div class="row g-2"> <!-- apertura de etiqueta div con clases de bootstrap que asigna cuantos intems del formulario pueden estar en fila -->
            <div class="col-lg-4"> <!-- apertura de etiqueta div con clases de bootstrap que permite a los items del formulario colocarlos uno al lado del otro -->
              <label for="Tallins" class="form-label" style="display: flex;">Taller(es) a Inscribir</label> <!-- etiqueta label que esta vinculada un input -->
            ...
            <div class="col-lg-3"> <!-- apertura de etiqueta div con clases de bootstrap que permite a los items del formulario colocarlos uno al lado del otro -->
              <label for="pay" class="form-label" style="display: flex;">Pago</label> <!-- etiqueta label que esta vinculada un input -->
              <input name="pago" id="pay" type="number" class="form-control" placeholder="Ingresar Monto" aria-describedby="pagoHelp" required> <!-- etiqueta input con un id, de tipo númerico, con una clase de bootstrap, con atributo de placeholder, y esta vinculada con un label -->
            </div> <!-- cierre de etiqueta div que permite a los items del formulario colocarlos uno al lado del otro -->
          </div>
<br> <!-- etiqueta de salto de linea -->

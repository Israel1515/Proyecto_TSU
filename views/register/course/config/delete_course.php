...
<center>
    <div class="offcanvas offcanvas-top show" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel" style="width: 40%; height: 25%; background-color: #f8d7da; position: relative;">
        ...
        <div class="offcanvas-body">
            ...
            <form action="../../../../models/eliminar_course_model.php" method="post">

            <label class="form-label" style="display: flex; color: #842029;">¿Esta seguro que desea eliminar este Taller?</label>
            ...
            <div class="botones">
                ...
                <a href="../../../main/course.php" class="btn btn-secondary">No</a>
            </div>
